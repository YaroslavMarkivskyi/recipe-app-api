...
This module defines viewsets for managing Recipe, Tag, and Ingredient
models using Django REST Framework. It includes custom filtering and
image upload functionalities for recipes.
"""
